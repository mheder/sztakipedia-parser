 ...
 * @since 2011
 */
public class TableRowHeadingTag extends AbstractTag {
	private String params;

	public TableRowHeadingTag() {
		super();
	}

	public TableRowHeadingTag(AbstractTag parent) {
		super(parent);
	}

	public TableRowHeadingTag(AbstractTag parent, String params) {
		super(parent);
		this.params = params;
	}
