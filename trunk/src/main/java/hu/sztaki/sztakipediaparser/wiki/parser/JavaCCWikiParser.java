...
public class JavaCCWikiParser implements IWikiParser, JavaCCWikiParserConstants {
	...
	final public String stringTag(boolean addTag) throws ParseException {
		...
		label_20: while (true) {
			...
			default:
				jj_la1[37] = jj_gen;
				if (getToken(1).kind == NEWLINE
						&& !(getToken(2).kind == HR && getToken(3).kind == NEWLINE)
						&& !(getToken(2).kind == SECTION_HEADING
								|| getToken(2).kind == SUBSECTION_HEADING || getToken(2).kind == SUB_SUBSECTION_HEADING)
	...
	final public String stringTagWithoutNewline(boolean addTag)
	...
	final public String stringTagWithoutNewlineAndPipe(boolean addTag)
			throws ParseException {
		Token t = null;
		String str = "";
		label_22: while (true) {
	...
	private boolean jj_3R_113() {
		if (jj_scan_token(TABLE_COL_HEADING))
			return true;
		return false;
	}

	private boolean jj_3R_75() {
		if (jj_scan_token(CBRACKET))
			return true;
		return false;
	}

	private boolean jj_3R_99() {
		if (jj_scan_token(ITALIC))
			return true;
		return false;
	}

	private boolean jj_3R_62() {
		if (jj_scan_token(DOCURL))
			return true;
		return false;
	}

	private boolean jj_3R_93() {
		if (jj_scan_token(SUB_SUBSECTION_HEADING))
			return true;
		return false;
	}
	...
	private boolean jj_3R_92() {
		if (jj_scan_token(SUBSECTION_HEADING))
			return true;
		return false;
	}
	...
	private boolean jj_3R_109() {
		if (jj_scan_token(INDENT))
			return true;
		return false;
	}

	private boolean jj_3R_58() {
		if (jj_scan_token(SECTION_HEADING))
			return true;
		return false;
	}

	private boolean jj_3R_98() {
		if (jj_scan_token(BOLD))
			return true;
		return false;
	}

	private boolean jj_3R_108() {
		if (jj_scan_token(DCBRACKET))
			return true;
		return false;
	}
	...
	private boolean jj_3R_102() {
		if (jj_scan_token(REFOPEN))
			return true;
		return false;
	}

	private boolean jj_3R_57() {
		if (jj_scan_token(BOLDITALIC))
			return true;
		return false;
	}
	...
	private boolean jj_3R_80() {
		if (jj_scan_token(TABLE_CAPTION))
			return true;
		return false;
	}
	...
	private boolean jj_3R_78() {
		if (jj_scan_token(TABLE_ROW_HEADING))
			return true;
		return false;
	}
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x1cd050, 0x7ffffff0, 0x7ffffff0, 0x77032f80,
				0x100, 0x400, 0x200, 0x77032f80, 0x400, 0xc00, 0xc00,
				0x10000000, 0x67032c00, 0x10000000, 0x7effffc0, 0x7effffc0,
				0xe00000, 0x771fff80, 0x771fff80, 0x20000000, 0x10000000,
				0xd040, 0x4d040, 0x8d040, 0x8000000, 0x77ffffc0, 0x77ffffc0,
				0x2000000, 0x2000000, 0x24fdf000, 0x4b000000, 0x7ffcf000,
				0x7ffcf000, 0x43000000, 0x43000000, 0x63000000, 0x63000000,
				0x17e32f80, 0x60000000, 0x77032f80, 0x77032f80, 0x67032c00,
				0x67032c00, };
	}
