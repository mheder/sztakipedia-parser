...
/**
 * Represents a table's caption in the AST.
 * 
 * @author <a href="mailto:sztakipedia@sztaki.hu">Tibor Olah</a>, <a
 *         href="http://sztaki.hu">MTA SZTAKI</a>
 * @since 2011
 */
public class TableCaptionTag extends AbstractTag {

	public TableCaptionTag() {
		super();
	}

	public TableCaptionTag(AbstractTag parent) {
		super(parent);
	}
