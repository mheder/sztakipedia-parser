...
/**
 * Visitor to convert the wiki AST to plain text, containing only the titles,
 * and the text of the article.
 * 
 * @note No template expansion takes place.
 * 
 * @author Tamas Farkas
 * 
 */
public class PlainTextContentWriter implements TagVisitor {
	 ...
	 * 
	 * @see
	 * hu.sztaki.sztakipediaparser.wiki.visitor.Visitor#dispatchVisit(hu.sztaki
	 * .sztakipediaparser.wiki.visitor.Visitable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.AnchorTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.BodyTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.BoldTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.DivTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.HeadingTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.HRTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.ImageTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.IndentTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.ItalicTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.ParagraphTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.RawWikiTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.ReferenceTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TextTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TableCaptionTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TableCellTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TableColHeadingTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TableRowHeadingTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TableRowTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TableTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TemplateParam)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.TemplateTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.UnorderedListItemTag)
	 */
	 ...
	 * 
	 * @see hu.sztaki.sztakipediaparser.wiki.visitor.TagVisitor#visit(hu.sztaki.
	 * sztakipediaparser.wiki.tags.UnorderedListTag)
	 */
